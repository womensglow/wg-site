...
export const SERVICES: Service[] = [
  ...
  { id: 'hw-6', category: 'Wax', subCategory: 'Honey', name: 'Only Half Legs', withoutProductPrice: 150, withProductPrice: 249, serviceType: 'both', duration: 12, image: '' },
  { id: 'hw-7', category: 'Wax', subCategory: 'Honey', name: 'Full Hand', withoutProductPrice: 150, withProductPrice: 249, serviceType: 'both', duration: 15, image: '' },
  { id: 'hw-8', category: 'Wax', subCategory: 'Honey', name: 'Half Back', withoutProductPrice: 120, withProductPrice: 155, serviceType: 'both', duration: 25, image: '' },
  { id: 'hw-9', category: 'Wax', subCategory: 'Honey', name: 'Full Back', withoutProductPrice: 180, withProductPrice: 320, serviceType: 'both', duration: 30, image: '' },
  { id: 'hw-10', category: 'Wax', subCategory: 'Honey', name: 'Bikini', withoutProductPrice: 300, withProductPrice: 599, serviceType: 'both', duration: 60, image: '' },
  { id: 'hw-11', category: 'Wax', subCategory: 'Honey', name: 'Bikini + Butt line', withoutProductPrice: 289, withProductPrice: 390, serviceType: 'both', duration: 70, image: '' },
  { id: 'hw-12', category: 'Wax', subCategory: 'Honey', name: 'Full Body', withoutProductPrice: 720, withProductPrice: 1299, serviceType: 'both', duration: 122, image: '' },
  { id: 'hw-13', category: 'Wax', subCategory: 'Honey', name: 'Stomach', withoutProductPrice: 120, withProductPrice: 240, serviceType: 'both',  duration: 25, image: '' },

  // Rica Wax
  { id: 'rw-1', category: 'Wax', subCategory: 'Rica', name: 'Full Arms + Full Legs + Underarms', withoutProductPrice: 385, withProductPrice: 899, serviceType: 'both', duration: 65, popular: true },
  { id: 'rw-2', category: 'Wax', subCategory: 'Rica', name: 'Full Arms + Half Legs + Underarms', withoutProductPrice: 300, withProductPrice: 799, serviceType: 'both', duration: 60 },
  { id: 'rw-3', category: 'Wax', subCategory: 'Rica', name: 'Full Arms + Underarms', withoutProductPrice: 150, withProductPrice: 299, serviceType: 'both', duration: 31 },
  { id: 'rw-4', category: 'Wax', subCategory: 'Rica', name: 'Only Underarms', withoutProductPrice: 48, withProductPrice: 59, serviceType: 'both', duration: 8 },
  { id: 'rw-5', category: 'Wax', subCategory: 'Rica', name: 'Half Legs', withoutProductPrice: 150, withProductPrice: 399, serviceType: 'both', duration: 12 },
  { id: 'rw-6', category: 'Wax', subCategory: 'Rica', name: 'Full Legs', withoutProductPrice: 200, withProductPrice: 399, serviceType: 'both', duration: 30 },
  { id: 'rw-7', category: 'Wax', subCategory: 'Rica', name: 'Full Arms', withoutProductPrice: 150, withProductPrice: 290, serviceType: 'both', duration: 15 },
  { id: 'rw-8', category: 'Wax', subCategory: 'Rica', name: 'Half Back', withoutProductPrice: 120, withProductPrice: 280, serviceType: 'both', duration: 25 },
  { id: 'rw-9', category: 'Wax', subCategory: 'Rica', name: 'Full Back', withoutProductPrice: 180, withProductPrice: 459, serviceType: 'both', duration: 30 },
  { id: 'rw-10', category: 'Wax', subCategory: 'Rica', name: 'Bikini', withoutProductPrice: 300, withProductPrice: 699, serviceType: 'both', duration: 60 },
  { id: 'rw-11', category: 'Wax', subCategory: 'Rica', name: 'Bikini + Butt Line', withoutProductPrice: 390, withProductPrice: 799, serviceType: 'both', duration: 70 },
  { id: 'rw-12', category: 'Wax', subCategory: 'Rica', name: 'Stomach', withoutProductPrice: 120, withProductPrice: 349, serviceType: 'both', duration: 25 },
  { id: 'rw-13', category: 'Wax', subCategory: 'Rica', name: 'Full Body', withoutProductPrice: 720, withProductPrice: 1599, serviceType: 'both', duration: 120 },
