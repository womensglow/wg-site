...
export const SERVICES: Service[] = [
  ...
  // Peel Off Wax
  { id: 'pow-1', category: 'Wax', name: 'Forehead', price: 60, duration: 5 },
  { id: 'pow-2', category: 'Wax', name: 'Upper Lip', price: 60, duration: 5 },
  { id: 'pow-3', category: 'Wax', name: 'Lower Lip', price: 60, duration: 5 },
  { id: 'pow-4', category: 'Wax', name: 'Chin', price: 60, duration: 5 },
  { id: 'pow-5', category: 'Wax', name: 'Side Lock', price: 139, duration: 10 },
  { id: 'pow-6', category: 'Wax', name: 'Full Face', price: 369, duration: 25 },
  { id: 'pow-7', category: 'Wax', name: 'Underarms', price: 80, duration: 8 },

  // Honey Wax
  { id: 'hw-1', category: 'Wax', name: 'Full Arms + Full Legs + Underarms', price: 549, duration: 65, popular: true },
  { id: 'hw-2', category: 'Wax', name: 'Full Arms + Half Legs + Underarms', price: 449, duration: 60 },
  { id: 'hw-3', category: 'Wax', name: 'Full Arms + Underarms', price: 249, duration: 31 },
  { id: 'hw-4', category: 'Wax', name: 'Only Underarms', price: 59, duration: 8 },
  { id: 'hw-5', category: 'Wax', name: 'Only Half Legs', price: 159, duration: 12 },
  { id: 'hw-6', category: 'Wax', name: 'Full Hand', price: 155, duration: 15 },
  { id: 'hw-7', category: 'Wax', name: 'Full Body', price: 1299, duration: 122 },
  { id: 'hw-8', category: 'Wax', name: 'Bikini', price: 599, duration: 60 },
  { id: 'hw-9', category: 'Wax', name: 'Half Back', price: 220, duration: 25 },
  { id: 'hw-10', category: 'Wax', name: 'Full Back', price: 385, duration: 30 },
  { id: 'hw-11', category: 'Wax', name: 'Stomach', price: 240, duration: 25 },

  // Rica Wax
  { id: 'rw-1', category: 'Wax', name: 'Full Arms + Full Legs + Underarms', price: 899, duration: 65, popular: true },
  { id: 'rw-2', category: 'Wax', name: 'Full Arms + Half Legs + Underarms', price: 799, duration: 60 },
  { id: 'rw-3', category: 'Wax', name: 'Full Arms + Underarms', price: 499, duration: 31 },
  { id: 'rw-4', category: 'Wax', name: 'Only Underarms', price: 79, duration: 8 },
  { id: 'rw-5', category: 'Wax', name: 'Only Half Legs', price: 399, duration: 12 },
  { id: 'rw-6', category: 'Wax', name: 'Full Hand', price: 399, duration: 15 },
  { id: 'rw-7', category: 'Wax', name: 'Full Body', price: 1699, duration: 122 },
  { id: 'rw-8', category: 'Wax', name: 'Bikini', price: 699, duration: 60 },
  { id: 'rw-9', category: 'Wax', name: 'Half Back', price: 299, duration: 25 },
  { id: 'rw-10', category: 'Wax', name: 'Full Back', price: 469, duration: 30 },
  { id: 'rw-11', category: 'Wax', name: 'Stomach', price: 349, duration: 25 },

  // Gel Wax
  { id: 'gw-1', category: 'Wax', name: 'Full Arms + Full Legs + Underarms', price: 699, duration: 65 },
  { id: 'gw-2', category: 'Wax', name: 'Full Arms + Half Legs + Underarms', price: 599, duration: 60 },
  { id: 'gw-3', category: 'Wax', name: 'Full Arms + Underarms', price: 449, duration: 31 },
  { id: 'gw-4', category: 'Wax', name: 'Only Underarms', price: 75, duration: 8 },
  { id: 'gw-5', category: 'Wax', name: 'Only Half Legs', price: 389, duration: 12 },
  { id: 'gw-6', category: 'Wax', name: 'Full Hand', price: 389, duration: 15 },
  { id: 'gw-7', category: 'Wax', name: 'Full Body', price: 1499, duration: 122 },
  { id: 'gw-8', category: 'Wax', name: 'Half Back', price: 295, duration: 25 },
  { id: 'gw-9', category: 'Wax', name: 'Full Back', price: 395, duration: 30 },
  { id: 'gw-10', category: 'Wax', name: 'Stomach', price: 299, duration: 25 },
  ...
  // Basic Facial
  { id: 'bf-1', category: 'Facial', name: 'Fruit Facial', price: 699, duration: 65 },
  { id: 'bf-2', category: 'Facial', name: 'De-Tan Facial', price: 695, duration: 65 },
  { id: 'bf-3', category: 'Facial', name: 'Red Wine Skin Tightening Facial', price: 795, duration: 65 },
  { id: 'bf-4', category: 'Facial', name: 'Gold Facial', price: 599, duration: 65 },
  { id: 'bf-5', category: 'Facial', name: 'Diamond Facial', price: 595, duration: 65 },

  // Classic Facial
  { id: 'cf-1', category: 'Facial', name: 'Korean Facial', price: 1199, duration: 75, popular: true },
  { id: 'cf-2', category: 'Facial', name: "Shine's Glow O3+ Facial", price: 1295, duration: 70 },
  { id: 'cf-3', category: 'Facial', name: 'O3+ Bridal Facial V-C', price: 1549, duration: 100 },
  { id: 'cf-4', category: 'Facial', name: 'O3+ Radiant Glow Bridal Facial', price: 1599, duration: 100 },
  { id: 'cf-5', category: 'Facial', name: 'Hydra Facial', price: 1699, duration: 80 },
  { id: 'cf-6', category: 'Facial', name: 'FYC Bridal Glow Facial', price: 1799, duration: 85 },

  // Advance Facial (Hydra)
  { id: 'af-1', category: 'Facial', name: 'Hydra Boost Facial', price: 2499, duration: 90, popular: true },
  { id: 'af-2', category: 'Facial', name: 'Korean Advance Facial', price: 2595, duration: 100 },
  { id: 'af-3', category: 'Facial', name: 'De-Tan Cleanup Advance', price: 1800, duration: 70 },
  { id: 'af-4', category: 'Facial', name: 'FYC Bridal Glow Advance Facial', price: 3899, duration: 100 },
  { id: 'af-5', category: 'Facial', name: 'Cashmara Facial', price: 3995, duration: 100 },
  { id: 'af-6', category: 'Facial', name: 'Gogi Facial', price: 4599, duration: 100 },
