...
export const IMAGE_REVIEWS: ImageReview[] = [
  {
    ...
    name: 'Pallavi S.',
    location: 'Agra, UP',
    imageSrc: '/attached_assets/generated_images/beauty-kit.jpg',
  ...
  },
  {
    ...
    name: 'Nisha K.',
    location: 'Agra, UP',
    imageSrc: '/attached_assets/generated_images/bridal.jpg',
...
export const VOICE_REVIEWS: VoiceReview[] = [
  {
    ...
    location: 'Agra, UP',
    rating: 5,
    audioSrc: '/attached_assets/generated_audio/voice_review_ritika.mp3',
    duration: '0:18',
  ...
  },
  {
    ...
    location: 'Agra, UP',
    rating: 5,
    audioSrc: '/attached_assets/generated_audio/voice_review_simran.mp3',
    duration: '0:20',
